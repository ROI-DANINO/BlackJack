...
> Watch the known Duolingo weakness here: it leans too hard on **recognition** (pick from a word bank) and too little on **production** (generate from scratch).
>
> **⚠ UNSUPPORTED — checked 2026-07-26, LDB-02.** This claim could not be backed first-hand. No independent review making it was found. What was found instead: Duolingo's own whitepaper describes recognition-first *onboarding* (§2.5, p.7 — and note it says "**receptive** exercises", not "recognition"), which supports the premise but not the criticism; and a 2024 *Language Learning & Technology* study reporting productive gains **matching or surpassing** receptive ones — Duolingo-funded, two of three authors Duolingo-affiliated, with the authors' own floor-effect caveat. A third study cited in this area concerns **Babbel**, not Duolingo. The line's own attribution at :147 names unnamed "independent reviews"; none was located. **Do not cite this claim downstream.** The design conclusion it supports — bias later lessons toward production — is defensible on other grounds; this sentence is not its evidence. Full record: `docs/superpowers/research/activity-pattern-catalog/run/U2/audit.md`. For blackjack, "production" = **the learner names the play before seeing options**, and ultimately plays live hands unaided. Bias your later lessons toward production, not multiple-choice, or you'll build players who can recognize the right answer but freeze at a real table.
