---
title: Per-Activity Evidence and Mastery Rules (LDB-04) — branch copy, not approved on main
...
> line, which reads *"Status: APPROVED 2026-07-30 (owner, gate user-approval)"*. **That status is a fact about the branch and not about this repo.**
> On `main`, **LDB-04 is in `Ready` at `Evidence: pending`** — the card has not been decided.
>
...
>
> **What this file is for:** evidence, read as *input* to the LDB-04 grill — an argued position worth
