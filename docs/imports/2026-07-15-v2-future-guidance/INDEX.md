...
| CLOUD-02 | Future hosted learning adds login, progress persistence, and cross-device sync. | Accepted + Covered | Approved cloud ADR; not implemented in the current React/WASM app. | [Architecture](../../architecture.md) owns the posture; [Roadmap](../../../ROADMAP.md) owns activation. | A real account, durable-progress, or cross-device consumer. |
...
| ID | Claim | Disposition | Existing evidence or conflict | Authoritative destination | Activation / research trigger |
|---|---|---|---|---|---|
| LEARNING-01 | Use a Duolingo-like short loop and premium game feel. | Covered | Already established by product vision and the learning loop. | [Product vision](../../specs/product-vision.md) | Visual implementation arrives through scoped T3 work. |
| LEARNING-02 | Deliver web first and mobile later. | Accepted + Covered | The browser product exists; explicit platform sequence was missing from the north star/roadmap. | [Product vision](../../specs/product-vision.md) owns the principle; [Roadmap](../../../ROADMAP.md) owns sequencing. | Mobile becomes an active product slice after web learning proves useful. |
