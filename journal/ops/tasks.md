...
- Gate: user-approval
- Evidence: pending
- Updated: 2026-07-30T07:54:21.488Z
...
- Load: docs/superpowers/research/evidence-index/activity-and-storage-catalog.md, docs/superpowers/specs/2026-07-22-product-design-inputs.md
- Gate: user-approval
- Evidence: DRAFT AWAITING APPROVAL — docs/superpowers/specs/2026-07-30-activity-taxonomy-and-capability-map.md, revised 2026-07-30 after adversarial examination. Examiner record: docs/superpowers/audits/2026-07-30-ldb-03-claim-examination.md (10 claims, 13 units: 2 Preserve, 7 Revise, 3 Relabel, 1 Replace). ALL non-Preserve verdicts landed and each verified present in the target file by positive enumeration (22/22). Substantive changes: condition 1 restated from a cardinality test to the classifier's actual effect-equivalence-via-supply criterion, element count demoted to illustration, and labelled Product judgement; the two conditions re-attributed as this document's own test rather than an excavation of the classifier's reasoning, whose recorded ground is supply not length; U3-7's sourced form now stated as satisfying condition 2 and indeterminate on condition 1, so the ruling constrains future instances and neither confirms nor overturns the catalog's call; B1's rejection re-grounded (not a sequencing task at all); A3's 'content is the soft-17 condition' struck as false against LDB-01's 'forced'; F2's A4 step list stated at six elements and reconciled against blackjack-basics.ts:199-210, which poses the same content as a two-option question and is cosmetic by condition 1; F2 demoted to supporting on A4 and its retention labelled a product judgement about isolation rather than coverage necessity; C-A's pseudo-quoted measurement prescription deleted and the clause re-labelled as operationalising A-24, with the against-asserted-class scoring rule stated and scope narrowed to §4.3's wording; P3's in-play behavioural half assigned to F3 and F5 dropped, with no amendment to LDB-01's recognition carve-out; C-B's 'decoration' claim registered as A-29; §6's three false supporting statements corrected and P2's no-family exception stated; §4.2 discharged by new contract C-F with the pool policy handed to LDB-06 by name, and F4-F7's absent requirement sets handed to LDB-07. STILL UNVERIFIED BY A SECOND HAND: the 12 figure/quote claims and the counts — the citation-verifier run was lost. §5's disposition arithmetic was checked by the examiner and found sound.
- Updated: 2026-07-30T09:16:02.892Z
