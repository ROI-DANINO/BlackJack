...
> **26 citations** — 9 original + 12 (C1-FP) + 5 (C1-R2). See "Findings added by remediation
...
- **"Everything calibrates from a population" is still NOT falsified, and C1-W explicitly does not
  ...
  collects no responses, yet the question put to the expert is literally "what percentage of students
  will answer this item correctly", and the yardstick is a government agency's population calibration.
