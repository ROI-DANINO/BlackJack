...
Its eight cards are on the board (`journal/tasks.md`, milestone `LDB`) — four Done, four open. See
the [roadmap](ROADMAP.md) for layers and phases, and for deliverable state.
